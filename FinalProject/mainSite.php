...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit_review'])) {
    ...
    $sql = "INSERT INTO professor_reviews (professor_name, review_text, rating, id) VALUES (:professor_name, :review_text, :rating, :id)";
    ...
    $sql = "SELECT registration.username, professor_reviews.professor_name, professor_reviews.review_text, professor_reviews.rating,
            professor_reviews.created_at FROM registration JOIN professor_reviews ON registration.id = professor_reviews.id";
    ...
    <div class="w3-container">
        ...
        <article>
            ...
            <form method="post" action="">
                ...
                <button class="w3-button w3-blue" type="submit" name="submit_review">Submit Review</button>
            </form>
